# -*- coding: utf-8 -*-
"""
Created on Wed Dec  1 12:10:18 2021
...
"""
Before the plots, a high number of simulations is performed for each value of rho, 
then the average and the standard deviation is updated recursively. The cycle stops when 
the standard deviation is less than 0.01*average and the number of iterations is above 100
